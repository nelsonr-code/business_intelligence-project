...
(
    ...
    nomb_subc VARCHAR(40), /* INCREMENTADO VARCHAR(50) CON ESTA NUEVA DATA. ES 20 EL ANTERIOR */
    id_cat INT NOT NULL,
...
(
    ...
    nomb_prod VARCHAR(50) NOT NULL, /* INCREMENTADO VARCHAR(50) CON ESTA NUEVA DATA. ES 30 EL ANTERIOR */
